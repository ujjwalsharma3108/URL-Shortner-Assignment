<div class="form-section">
    <div class="form-copy">
        ...
        <p>Create a company and its primary Admin together. The Admin receives a secure password setup email.</p>
    </div>
    ...
    <form class="form-grid" action="{{ route('companies.store') }}" method="POST">
        ...
        <div class="form-actions">
            <button class="button" type="submit">Create company &amp; invite Admin</button>
        </div>
    </form>
</div>
...
@if ($companies->isNotEmpty())
    <div class="form-section">
        <div class="form-copy">
            ...
            <p>Invite another administrator to an existing company without changing its primary setup.</p>
        </div>
        ...
        <form class="form-grid" action="{{ route('admin-invitations.store') }}" method="POST">
            ...
            <div class="form-actions">
                <button class="button" type="submit">Invite company Admin</button>
            </div>
        </form>
    </div>
@endif
