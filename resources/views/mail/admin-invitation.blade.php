...
This invitation expires on {{ $invitation->expires_at->format('d M Y \a\t h:i A T') }}.
After accepting it, you will create your password and can sign in to {{ config('app.name') }} immediately.
